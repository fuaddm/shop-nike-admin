...
export async function clientAction({ request }: Route.ClientActionArgs) {
  ...
  if (actionMethod === 'add') {
    ...
    images.forEach((file) => postFormData.append('images', file));
  ...
  } else if (actionMethod === 'toggle-status') {
    const productId = String(formData.get('productId'));

    return await mainAPI.patch(`/admin/products/${productId}/toggle-status`, null, {
      headers: { token },
    });
  }
